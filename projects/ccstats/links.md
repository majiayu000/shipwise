...
- Reddit: not posted; explicit platform/account authorization required
- Product Hunt: not selected for first wave
- Blog: not selected for first wave
- Draft copy: projects/ccstats/copy/
