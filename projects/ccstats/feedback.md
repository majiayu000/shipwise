...
| ccstats discoverability refresh | Gate blocker | The local SEO Agent Suite checkout does not expose the documented `repo_seo_baseline.py --project-yaml` capability. | Recorded by https://github.com/majiayu000/shipwise/pull/13; update SEO Agent Suite to a supporting revision, then rerun the documented gate. |
